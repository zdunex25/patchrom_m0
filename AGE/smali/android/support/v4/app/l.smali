...
.method a(Landroid/support/v4/app/Fragment;IZI)Landroid/view/animation/Animation;
    ...
    :cond_3
    invoke-static {p2, p3}, Landroid/support/v4/app/l;->b(IZ)I
    ...
    invoke-static {v0, v1, v3, v4, v3}, Landroid/support/v4/app/l;->a(Landroid/content/Context;FFFF)Landroid/view/animation/Animation;
    ...
    invoke-static {v0, v3, v5, v3, v4}, Landroid/support/v4/app/l;->a(Landroid/content/Context;FFFF)Landroid/view/animation/Animation;
    ...
    invoke-static {v0, v5, v3, v4, v3}, Landroid/support/v4/app/l;->a(Landroid/content/Context;FFFF)Landroid/view/animation/Animation;
    ...
    invoke-static {v0, v3, v1, v3, v4}, Landroid/support/v4/app/l;->a(Landroid/content/Context;FFFF)Landroid/view/animation/Animation;
    ...
    invoke-static {v0, v4, v3}, Landroid/support/v4/app/l;->a(Landroid/content/Context;FF)Landroid/view/animation/Animation;
    ...
    invoke-static {v0, v3, v4}, Landroid/support/v4/app/l;->a(Landroid/content/Context;FF)Landroid/view/animation/Animation;
...
.method a(IIIZ)V
    ...
    iget-object v0, v1, Landroid/support/v4/app/Fragment;->K:Landroid/support/v4/app/s;
    ...
    invoke-virtual {v0}, Landroid/support/v4/app/g;->c()V
...
.method a(IZ)V
    ...
    invoke-virtual {p0, p1, v0, v0, p2}, Landroid/support/v4/app/l;->a(IIIZ)V
...
.method a(Landroid/os/Parcelable;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v0, p0}, Landroid/support/v4/app/BackStackState;->a(Landroid/support/v4/app/l;)Landroid/support/v4/app/b;
    ...
    invoke-virtual {p0, v1, v0}, Landroid/support/v4/app/l;->a(ILandroid/support/v4/app/b;)V
...
.method public a(Landroid/support/v4/app/Fragment;II)V
    ...
    iget-boolean v2, p1, Landroid/support/v4/app/Fragment;->C:Z
...
.method a(Landroid/support/v4/app/Fragment;IIIZ)V
    ...
    iget v1, p1, Landroid/support/v4/app/Fragment;->v:I
    ...
    invoke-virtual {p0, p1, p3, v5, p4}, Landroid/support/v4/app/l;->a(Landroid/support/v4/app/Fragment;IZI)Landroid/view/animation/Animation;
    ...
    invoke-virtual {p0, p1}, Landroid/support/v4/app/l;->e(Landroid/support/v4/app/Fragment;)V
    ...
    invoke-virtual {p0, p1, p3, v3, p4}, Landroid/support/v4/app/l;->a(Landroid/support/v4/app/Fragment;IZI)Landroid/view/animation/Animation;
    ...
    invoke-direct {v1, p0, p1}, Landroid/support/v4/app/m;-><init>(Landroid/support/v4/app/l;Landroid/support/v4/app/Fragment;)V
...
.method public a(Landroid/support/v4/app/Fragment;Z)V
    ...
    :cond_1
    invoke-virtual {p0, p1}, Landroid/support/v4/app/l;->c(Landroid/support/v4/app/Fragment;)V
...
.method public a(Landroid/view/Menu;)Z
    ...
    iget-boolean v3, v0, Landroid/support/v4/app/Fragment;->C:Z
...
.method public b(Landroid/support/v4/app/Fragment;II)V
    ...
    invoke-virtual {p0, p1, p2, v3, p3}, Landroid/support/v4/app/l;->a(Landroid/support/v4/app/Fragment;IZI)Landroid/view/animation/Animation;
...
.method public b()Z
    ...
    invoke-virtual {p0}, Landroid/support/v4/app/l;->a()Z
    ...
    invoke-virtual {p0, v0, v1, v2, v3}, Landroid/support/v4/app/l;->a(Landroid/os/Handler;Ljava/lang/String;II)Z
...
.method public c(Landroid/support/v4/app/Fragment;II)V
    ...
    invoke-virtual {p0, p1, p2, v4, p3}, Landroid/support/v4/app/l;->a(Landroid/support/v4/app/Fragment;IZI)Landroid/view/animation/Animation;
...
.method public d()Z
    ...
    iget-object v5, v0, Landroid/support/v4/app/Fragment;->K:Landroid/support/v4/app/s;

    if-eqz v5, :cond_3

    iget-object v0, v0, Landroid/support/v4/app/Fragment;->K:Landroid/support/v4/app/s;
...
.method e()V
    ...
    invoke-interface {v0}, Landroid/support/v4/app/k;->a()V
...
.method f(Landroid/support/v4/app/Fragment;)Landroid/os/Bundle;
    ...
    iget-object v0, p0, Landroid/support/v4/app/l;->u:Landroid/os/Bundle;
    ...
    iput-object v0, p0, Landroid/support/v4/app/l;->u:Landroid/os/Bundle;
...
.method g()Landroid/os/Parcelable;
    ...
    invoke-virtual {p0, v1, v3, v2, v4}, Landroid/support/v4/app/l;->a(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v4/app/l;->f(Landroid/support/v4/app/Fragment;)Landroid/os/Bundle;
    ...
    invoke-virtual {p0, v8, v9, v10}, Landroid/support/v4/app/l;->a(Landroid/os/Bundle;Ljava/lang/String;Landroid/support/v4/app/Fragment;)V
    ...
    :cond_6
    :goto_2
    sget-boolean v8, Landroid/support/v4/app/l;->a:Z
    ...
    iget-object v5, p0, Landroid/support/v4/app/l;->g:Ljava/util/ArrayList;
    ...
    invoke-direct {v4, p0, v0}, Landroid/support/v4/app/BackStackState;-><init>(Landroid/support/v4/app/l;Landroid/support/v4/app/b;)V
...
.method public i()V
    ...
    invoke-virtual {p0, v0, v1}, Landroid/support/v4/app/l;->a(IZ)V
...
.method public p()V
    ...
    invoke-virtual {p0, v1, v1}, Landroid/support/v4/app/l;->a(IZ)V
