...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/camera/Util$BackgroundJob;
    }
.end annotation
...
.method public static createSetAsIntent(Lcom/android/camera/gallery/IImage;)Landroid/content/Intent;
    .locals 4
    .parameter "image"

    .prologue
    .line 534
    invoke-interface {p0}, Lcom/android/camera/gallery/IImage;->fullSizeImageUri()Landroid/net/Uri;
...
.method public static decodeRgbaBitmap([B[Ljava/lang/Integer;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v0, v14}, Lcom/android/camera/Util;->byteArrayToInt([BI)I
...
.method public static declared-synchronized getNullOnClickListener()Landroid/view/View$OnClickListener;
    ...
    :try_start_0
    sget-object v0, Lcom/android/camera/Util;->sNullOnClickListener:Landroid/view/View$OnClickListener;
    ...
    invoke-direct {v0}, Lcom/android/camera/Util$1;-><init>()V

    sput-object v0, Lcom/android/camera/Util;->sNullOnClickListener:Landroid/view/View$OnClickListener;
...
.method public static makeBitmap(IILandroid/net/Uri;Landroid/content/ContentResolver;Landroid/os/ParcelFileDescriptor;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    .line 396
    :try_start_0
    invoke-static {p2, p3}, Lcom/android/camera/Util;->makeInputStream(Landroid/net/Uri;Landroid/content/ContentResolver;)Landroid/os/ParcelFileDescriptor;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 420
    invoke-static {p4}, Lcom/android/camera/Util;->closeSilently(Landroid/os/ParcelFileDescriptor;)V
    ...
    invoke-virtual {v4, v1, p5}, Lcom/android/camera/BitmapManager;->decodeFileDescriptor(Ljava/io/FileDescriptor;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    :cond_4
    :try_start_2
    invoke-static {p5, p0, p1}, Lcom/android/camera/Util;->computeSampleSize(Landroid/graphics/BitmapFactory$Options;II)I
...
.method public static makeBitmap(IILandroid/net/Uri;Landroid/content/ContentResolver;Z)Landroid/graphics/Bitmap;
    ...
    .line 370
    invoke-static {}, Lcom/android/camera/Util;->createNativeAllocOptions()Landroid/graphics/BitmapFactory$Options;
    ...
    .line 372
    invoke-static/range {v0 .. v5}, Lcom/android/camera/Util;->makeBitmap(IILandroid/net/Uri;Landroid/content/ContentResolver;Landroid/os/ParcelFileDescriptor;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 377
    invoke-static {v4}, Lcom/android/camera/Util;->closeSilently(Landroid/os/ParcelFileDescriptor;)V
...
.method public static openCamera(Landroid/app/Activity;I)Lcom/sec/android/seccamera/SecCamera;
    ...
    invoke-virtual {v2, p1}, Lcom/android/camera/CameraHolder;->open(I)Lcom/sec/android/seccamera/SecCamera;
    :try_end_0
...
.method public static showFatalErrorAndFinish(Landroid/app/Activity;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v0, p0}, Lcom/android/camera/Util$2;-><init>(Landroid/app/Activity;)V
...
.method public static startBackgroundJob(Lcom/android/camera/MonitoredActivity;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Runnable;Landroid/os/Handler;)V
    .locals 2
    .parameter "activity"
    .parameter "title"
    .parameter "message"
    ...
    new-instance v1, Lcom/android/camera/Util$BackgroundJob;

    invoke-direct {v1, p0, p3, p4}, Lcom/android/camera/Util$BackgroundJob;-><init>(Lcom/android/camera/MonitoredActivity;Ljava/lang/Runnable;Landroid/os/Handler;)V
...
.method public static viewUri(Landroid/net/Uri;Landroid/content/Context;)V
    ...
    invoke-static {p0, v1}, Lcom/android/camera/Util;->isUriValid(Landroid/net/Uri;Landroid/content/ContentResolver;)Z
