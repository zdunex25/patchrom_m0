.class public Lcom/android/camera/Mp4SlowMotionMaker;
...
.method private findAtom(Ljava/lang/String;)Z
    ...
    .local v3, size:I
    :cond_0
    iget-object v10, p0, Lcom/android/camera/Mp4SlowMotionMaker;->mFile:Ljava/io/RandomAccessFile;
    ...
    invoke-direct {p0, v4, v10}, Lcom/android/camera/Mp4SlowMotionMaker;->byteArrayToLong([BI)J
...
.method private getTimeBytes()I
    ...
    .prologue
    .line 137
    iget-object v1, p0, Lcom/android/camera/Mp4SlowMotionMaker;->mFile:Ljava/io/RandomAccessFile;
...
.method private modifyData(IDI)Z
    ...
    .line 88
    iget-object v4, p0, Lcom/android/camera/Mp4SlowMotionMaker;->mFile:Ljava/io/RandomAccessFile;
    ...
    .line 94
    invoke-direct {p0, v0, v9}, Lcom/android/camera/Mp4SlowMotionMaker;->byteArrayToInt([BI)I
    ...
    iget-object v5, p0, Lcom/android/camera/Mp4SlowMotionMaker;->mFile:Ljava/io/RandomAccessFile;
    ...
    invoke-direct {p0, v2, v9}, Lcom/android/camera/Mp4SlowMotionMaker;->intToByteArray(II)[B
...
.method private modifyMdhdData(D)Z
    ...
    invoke-direct {p0, v3}, Lcom/android/camera/Mp4SlowMotionMaker;->findAtom(Ljava/lang/String;)Z
    ...
    .line 80
    :cond_1
    invoke-direct {p0}, Lcom/android/camera/Mp4SlowMotionMaker;->getTimeBytes()I
    ...
    invoke-direct {p0, v1, v3, v4, v2}, Lcom/android/camera/Mp4SlowMotionMaker;->modifyData(IDI)Z
...
.method private modifyMvhdData(D)Z
    ...
    invoke-direct {p0, v2}, Lcom/android/camera/Mp4SlowMotionMaker;->findAtom(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, v1, v2, v3, v4}, Lcom/android/camera/Mp4SlowMotionMaker;->modifyData(IDI)Z
...
.method public makeMp4Slow(Ljava/lang/String;D)Z
    ...
    iput-object v1, p0, Lcom/android/camera/Mp4SlowMotionMaker;->mFile:Ljava/io/RandomAccessFile;
    ...
    invoke-direct {p0, v1}, Lcom/android/camera/Mp4SlowMotionMaker;->findAtom(Ljava/lang/String;)Z

    move-result v1

    if-eqz v1, :cond_1

    invoke-direct {p0, p2, p3}, Lcom/android/camera/Mp4SlowMotionMaker;->modifyMvhdData(D)Z

    move-result v1

    if-eqz v1, :cond_1

    invoke-direct {p0, p2, p3}, Lcom/android/camera/Mp4SlowMotionMaker;->modifyTkhdData(D)Z

    move-result v1

    if-eqz v1, :cond_1

    invoke-direct {p0, p2, p3}, Lcom/android/camera/Mp4SlowMotionMaker;->modifyMdhdData(D)Z
    ...
    .line 47
    iget-object v0, p0, Lcom/android/camera/Mp4SlowMotionMaker;->mFile:Ljava/io/RandomAccessFile;
