...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/camera/gallery/ImageListUber$1;,
...
.method public getBucketIds()Ljava/util/HashMap;
    ...
    iget-object v0, p0, Lcom/android/camera/gallery/ImageListUber;->mSubList:[Lcom/android/camera/gallery/IImageList;

    .local v0, arr$:[Lcom/android/camera/gallery/IImageList;
    array-length v3, v0
    ...
    .line 75
    .local v4, list:Lcom/android/camera/gallery/IImageList;
    invoke-interface {v4}, Lcom/android/camera/gallery/IImageList;->getBucketIds()Ljava/util/HashMap;
    ...
    .line 77
    .end local v4           #list:Lcom/android/camera/gallery/IImageList;
    :cond_0
    return-object v1
.end method
...
.method public getCount()I
    ...
    .line 83
    .local v4, subList:Lcom/android/camera/gallery/IImageList;
    invoke-interface {v4}, Lcom/android/camera/gallery/IImageList;->getCount()I
    ...
    .line 85
    .end local v4           #subList:Lcom/android/camera/gallery/IImageList;
    :cond_0
    return v1
.end method
...
.method public getImageForUri(Landroid/net/Uri;)Lcom/android/camera/gallery/IImage;
    ...
    .line 169
    .local v4, sublist:Lcom/android/camera/gallery/IImageList;
    invoke-interface {v4, p1}, Lcom/android/camera/gallery/IImageList;->getImageForUri(Landroid/net/Uri;)Lcom/android/camera/gallery/IImage;

    move-result-object v2

    .line 170
    .local v2, image:Lcom/android/camera/gallery/IImage;
    if-eqz v2, :cond_0

    .line 173
    .end local v2           #image:Lcom/android/camera/gallery/IImage;
    .end local v4           #sublist:Lcom/android/camera/gallery/IImageList;
    :goto_1
    return-object v2

    .line 168
    .restart local v2       #image:Lcom/android/camera/gallery/IImage;
    .restart local v4       #sublist:Lcom/android/camera/gallery/IImageList;
    :cond_0
...
.method public isEmpty()Z
    ...
    .line 90
    .local v3, subList:Lcom/android/camera/gallery/IImageList;
    invoke-interface {v3}, Lcom/android/camera/gallery/IImageList;->isEmpty()Z
    ...
    .line 93
    .end local v3           #subList:Lcom/android/camera/gallery/IImageList;
    :goto_1
    return v4

    .line 89
    .restart local v3       #subList:Lcom/android/camera/gallery/IImageList;
    :cond_0
    add-int/lit8 v1, v1, 0x1
