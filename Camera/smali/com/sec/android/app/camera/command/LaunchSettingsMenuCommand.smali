.class public Lcom/android/camera/command/LaunchSettingsMenuCommand;
...
.method public constructor <init>(Lcom/android/camera/AbstractCameraActivity;Lcom/sec/android/glview/TwGLViewGroup;Lcom/android/camera/MenuResourceDepot;Lcom/android/camera/resourcedata/MenuResourceBase;)V
    ...
    iput v0, p0, Lcom/android/camera/command/LaunchSettingsMenuCommand;->mSlideDirection:I

    .line 44
    iput-object p1, p0, Lcom/android/camera/command/LaunchSettingsMenuCommand;->mActivityContext:Lcom/android/camera/AbstractCameraActivity;

    .line 45
    iput-object p2, p0, Lcom/android/camera/command/LaunchSettingsMenuCommand;->mParentView:Lcom/sec/android/glview/TwGLViewGroup;

    .line 46
    iput-object p3, p0, Lcom/android/camera/command/LaunchSettingsMenuCommand;->mMenuDepot:Lcom/android/camera/MenuResourceDepot;

    .line 47
    iput-object p4, p0, Lcom/android/camera/command/LaunchSettingsMenuCommand;->mResourceData:Lcom/android/camera/resourcedata/MenuResourceBase;
...
.method public execute()V
    ...
    .prologue
    .line 60
    iget-object v1, p0, Lcom/android/camera/command/LaunchSettingsMenuCommand;->mActivityContext:Lcom/android/camera/AbstractCameraActivity;
    ...
    .line 82
    :cond_3
    iget-object v1, p0, Lcom/android/camera/command/LaunchSettingsMenuCommand;->mMenuDepot:Lcom/android/camera/MenuResourceDepot;

    iget-object v1, v1, Lcom/android/camera/MenuResourceDepot;->mMenus:Ljava/util/HashMap;

    iget-object v2, p0, Lcom/android/camera/command/LaunchSettingsMenuCommand;->mResourceData:Lcom/android/camera/resourcedata/MenuResourceBase;
    ...
    .line 84
    new-instance v0, Lcom/android/camera/glwidget/TwGLSettingsMenu;
    ...
    iget-object v3, p0, Lcom/android/camera/command/LaunchSettingsMenuCommand;->mParentView:Lcom/sec/android/glview/TwGLViewGroup;

    iget-object v4, p0, Lcom/android/camera/command/LaunchSettingsMenuCommand;->mResourceData:Lcom/android/camera/resourcedata/MenuResourceBase;

    iget-object v5, p0, Lcom/android/camera/command/LaunchSettingsMenuCommand;->mMenuDepot:Lcom/android/camera/MenuResourceDepot;

    iget v6, p0, Lcom/android/camera/command/MenuCommand;->mZOrder:I

    iget v7, p0, Lcom/android/camera/command/LaunchSettingsMenuCommand;->mSlideDirection:I

    invoke-direct/range {v0 .. v7}, Lcom/android/camera/glwidget/TwGLSettingsMenu;-><init>(Lcom/android/camera/AbstractCameraActivity;ILcom/sec/android/glview/TwGLViewGroup;Lcom/android/camera/resourcedata/MenuResourceBase;Lcom/android/camera/MenuResourceDepot;II)V
...
.method public setSliderDirection(I)V
    ...
    .prologue
    .line 55
    iput p1, p0, Lcom/android/camera/command/LaunchSettingsMenuCommand;->mSlideDirection:I
