...
.method public static buildCommand(ILcom/sec/android/app/camera/AbstractCameraActivity;Lcom/sec/android/glview/TwGLViewGroup;Lcom/sec/android/app/camera/MenuResourceDepot;I)Lcom/sec/android/app/camera/command/MenuCommand;
    ...
    .line 90
    new-instance v0, Lcom/sec/android/app/camera/command/LaunchHDROptionMenuCommand;

    .end local v0           #command:Lcom/sec/android/app/camera/command/MenuCommand;
    invoke-direct {v0, p1, p2, p3, v4}, Lcom/sec/android/app/camera/command/LaunchHDROptionMenuCommand;-><init>(Lcom/sec/android/app/camera/AbstractCameraActivity;Lcom/sec/android/glview/TwGLViewGroup;Lcom/sec/android/app/camera/MenuResourceDepot;Lcom/sec/android/app/camera/resourcedata/MenuResourceBase;)V

    .restart local v0       #command:Lcom/sec/android/app/camera/command/MenuCommand;
    move-object v1, v0

    .line 91
    check-cast v1, Lcom/sec/android/app/camera/command/LaunchHDROptionMenuCommand;

    invoke-virtual {v1, p4}, Lcom/sec/android/app/camera/command/LaunchHDROptionMenuCommand;->setZOrder(I)V
    ...
    .line 518
    :sswitch_29
    new-instance v0, Lcom/sec/android/app/camera/command/HDRIntensityModeSelectCommand;

    invoke-direct {v0, p1, p0}, Lcom/sec/android/app/camera/command/HDRIntensityModeSelectCommand;-><init>(Lcom/sec/android/app/camera/AbstractCameraActivity;I)V

    goto/16 :goto_0

    .line 523
    :sswitch_2a
    new-instance v0, Lcom/sec/android/app/camera/command/HDRPictureModeSelectCommand;

    invoke-direct {v0, p1, p0}, Lcom/sec/android/app/camera/command/HDRPictureModeSelectCommand;-><init>(Lcom/sec/android/app/camera/AbstractCameraActivity;I)V
