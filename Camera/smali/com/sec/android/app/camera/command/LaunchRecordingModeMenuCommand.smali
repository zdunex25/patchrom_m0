.class public Lcom/android/camera/command/LaunchRecordingModeMenuCommand;
...
.method public constructor <init>(Lcom/android/camera/AbstractCameraActivity;Lcom/sec/android/glview/TwGLViewGroup;Lcom/android/camera/MenuResourceDepot;Lcom/android/camera/resourcedata/MenuResourceBase;)V
    ...
    iput v0, p0, Lcom/android/camera/command/LaunchRecordingModeMenuCommand;->mSlideDirection:I

    .line 48
    iput-object p1, p0, Lcom/android/camera/command/LaunchRecordingModeMenuCommand;->mActivityContext:Lcom/android/camera/AbstractCameraActivity;

    .line 49
    iput-object p2, p0, Lcom/android/camera/command/LaunchRecordingModeMenuCommand;->mParentView:Lcom/sec/android/glview/TwGLViewGroup;

    .line 50
    iput-object p3, p0, Lcom/android/camera/command/LaunchRecordingModeMenuCommand;->mMenuDepot:Lcom/android/camera/MenuResourceDepot;

    .line 51
    iput-object p4, p0, Lcom/android/camera/command/LaunchRecordingModeMenuCommand;->mResourceData:Lcom/android/camera/resourcedata/MenuResourceBase;
...
.method public execute()V
    ...
    .line 56
    iget-object v1, p0, Lcom/android/camera/command/LaunchRecordingModeMenuCommand;->mActivityContext:Lcom/android/camera/AbstractCameraActivity;
    ...
    .line 80
    iget-object v1, p0, Lcom/android/camera/command/LaunchRecordingModeMenuCommand;->mMenuDepot:Lcom/android/camera/MenuResourceDepot;
    ...
    .line 82
    new-instance v1, Lcom/android/camera/resourcedata/RecordingModeResourceData;

    iget-object v3, p0, Lcom/android/camera/command/LaunchRecordingModeMenuCommand;->mActivityContext:Lcom/android/camera/AbstractCameraActivity;

    invoke-direct {v1, v3}, Lcom/android/camera/resourcedata/RecordingModeResourceData;-><init>(Lcom/android/camera/AbstractCameraActivity;)V

    iput-object v1, p0, Lcom/android/camera/command/LaunchRecordingModeMenuCommand;->mResourceData:Lcom/android/camera/resourcedata/MenuResourceBase;
    ...
    iget-object v3, p0, Lcom/android/camera/command/LaunchRecordingModeMenuCommand;->mParentView:Lcom/sec/android/glview/TwGLViewGroup;

    iget-object v4, p0, Lcom/android/camera/command/LaunchRecordingModeMenuCommand;->mResourceData:Lcom/android/camera/resourcedata/MenuResourceBase;

    iget-object v5, p0, Lcom/android/camera/command/LaunchRecordingModeMenuCommand;->mMenuDepot:Lcom/android/camera/MenuResourceDepot;

    iget v6, p0, Lcom/android/camera/command/MenuCommand;->mZOrder:I

    iget v7, p0, Lcom/android/camera/command/LaunchRecordingModeMenuCommand;->mSlideDirection:I
    ...
    .line 89
    new-instance v1, Lcom/android/camera/resourcedata/RecordingModeSpeedMotionResourceData;

    iget-object v2, p0, Lcom/android/camera/command/LaunchRecordingModeMenuCommand;->mActivityContext:Lcom/android/camera/AbstractCameraActivity;

    invoke-direct {v1, v2}, Lcom/android/camera/resourcedata/RecordingModeSpeedMotionResourceData;-><init>(Lcom/android/camera/AbstractCameraActivity;)V
