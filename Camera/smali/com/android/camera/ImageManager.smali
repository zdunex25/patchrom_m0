...
.method public static addImage(Landroid/content/ContentResolver;Ljava/lang/String;JLandroid/location/Location;Ljava/lang/String;Ljava/lang/String;Landroid/graphics/Bitmap;[B[II)Landroid/net/Uri;
    ...
    .prologue
    .line 235
    invoke-static/range {p0 .. p9}, Lcom/android/camera/ImageManager;->addImage(Landroid/content/ContentResolver;Ljava/lang/String;JLandroid/location/Location;Ljava/lang/String;Ljava/lang/String;Landroid/graphics/Bitmap;[B[I)Landroid/net/Uri;
...
.method public static makeImageList(Landroid/content/ContentResolver;Lcom/android/camera/ImageManager$ImageListParam;)Lcom/android/camera/gallery/IImageList;
    ...
    iget-object v13, v0, Lcom/android/camera/ImageManager$ImageListParam;->mLocation:Lcom/android/camera/ImageManager$DataLocation;

    .line 345
    .local v13, location:Lcom/android/camera/ImageManager$DataLocation;
    move-object/from16 v0, p1

    iget v8, v0, Lcom/android/camera/ImageManager$ImageListParam;->mInclusion:I

    .line 346
    .local v8, inclusion:I
    move-object/from16 v0, p1

    iget v5, v0, Lcom/android/camera/ImageManager$ImageListParam;->mSort:I

    .line 347
    .local v5, sort:I
    move-object/from16 v0, p1

    iget-object v6, v0, Lcom/android/camera/ImageManager$ImageListParam;->mBucketId:Ljava/lang/String;

    .line 348
    .local v6, bucketId:Ljava/lang/String;
    move-object/from16 v0, p1

    iget-object v14, v0, Lcom/android/camera/ImageManager$ImageListParam;->mSingleImageUri:Landroid/net/Uri;

    .line 349
    .local v14, singleImageUri:Landroid/net/Uri;
    move-object/from16 v0, p1

    iget-boolean v9, v0, Lcom/android/camera/ImageManager$ImageListParam;->mIsEmptyImageList:Z
    ...
    .line 352
    :cond_0
    new-instance v12, Lcom/android/camera/ImageManager$EmptyImageList;

    const/4 v1, 0x0

    invoke-direct {v12, v1}, Lcom/android/camera/ImageManager$EmptyImageList;-><init>(Lcom/android/camera/ImageManager$1;)V
    ...
    .line 356
    new-instance v12, Lcom/android/camera/gallery/SingleImageList;

    move-object/from16 v0, p0

    invoke-direct {v12, v0, v14}, Lcom/android/camera/gallery/SingleImageList;-><init>(Landroid/content/ContentResolver;Landroid/net/Uri;)V
    ...
    .line 365
    .local v11, l:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/camera/gallery/BaseImageList;>;"
    if-eqz v7, :cond_4
    ...
    .line 367
    new-instance v1, Lcom/android/camera/gallery/ImageList;

    sget-object v3, Lcom/android/camera/ImageManager;->STORAGE_URI:Landroid/net/Uri;

    sget-object v4, Lcom/android/camera/ImageManager;->THUMB_URI:Landroid/net/Uri;

    move-object/from16 v2, p0

    invoke-direct/range {v1 .. v6}, Lcom/android/camera/gallery/ImageList;-><init>(Landroid/content/ContentResolver;Landroid/net/Uri;Landroid/net/Uri;ILjava/lang/String;)V
    ...
    .line 371
    new-instance v1, Lcom/android/camera/gallery/VideoList;

    sget-object v2, Lcom/android/camera/ImageManager;->VIDEO_STORAGE_URI:Landroid/net/Uri;

    move-object/from16 v0, p0

    invoke-direct {v1, v0, v2, v5, v6}, Lcom/android/camera/gallery/VideoList;-><init>(Landroid/content/ContentResolver;Landroid/net/Uri;ILjava/lang/String;)V
    ...
    .line 382
    new-instance v1, Lcom/android/camera/gallery/DrmImageList;

    sget-object v2, Landroid/provider/DrmStore$Images;->CONTENT_URI:Landroid/net/Uri;

    move-object/from16 v0, p0

    invoke-direct {v1, v0, v2, v5, v6}, Lcom/android/camera/gallery/DrmImageList;-><init>(Landroid/content/ContentResolver;Landroid/net/Uri;ILjava/lang/String;)V
    ...
    .line 390
    .local v10, iter:Ljava/util/Iterator;,"Ljava/util/Iterator<Lcom/android/camera/gallery/BaseImageList;>;"
    :cond_8
    :goto_1
    ...
    check-cast v15, Lcom/android/camera/gallery/BaseImageList;

    .line 392
    .local v15, sublist:Lcom/android/camera/gallery/BaseImageList;
    invoke-virtual {v15}, Lcom/android/camera/gallery/BaseImageList;->isEmpty()Z
    ...
    .line 393
    invoke-virtual {v15}, Lcom/android/camera/gallery/BaseImageList;->close()V
    ...
    .line 398
    .end local v15           #sublist:Lcom/android/camera/gallery/BaseImageList;
    :cond_9
    ...
    check-cast v12, Lcom/android/camera/gallery/BaseImageList;

    .line 400
    .local v12, list:Lcom/android/camera/gallery/BaseImageList;
    goto/16 :goto_0

    .line 403
    .end local v12           #list:Lcom/android/camera/gallery/BaseImageList;
    :cond_a
    new-instance v16, Lcom/android/camera/gallery/ImageListUber;

    invoke-virtual {v11}, Ljava/util/ArrayList;->size()I

    move-result v1

    new-array v1, v1, [Lcom/android/camera/gallery/IImageList;

    invoke-virtual {v11, v1}, Ljava/util/ArrayList;->toArray([Ljava/lang/Object;)[Ljava/lang/Object;

    move-result-object v1

    check-cast v1, [Lcom/android/camera/gallery/IImageList;

    move-object/from16 v0, v16

    invoke-direct {v0, v1, v5}, Lcom/android/camera/gallery/ImageListUber;-><init>([Lcom/android/camera/gallery/IImageList;I)V

    .local v16, uber:Lcom/android/camera/gallery/ImageListUber;
