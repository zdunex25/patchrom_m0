.class public Lcom/android/camera/command/LaunchListTypeMenuCommand;
...
.method public constructor <init>(Lcom/android/camera/AbstractCameraActivity;Lcom/sec/android/glview/TwGLViewGroup;Lcom/android/camera/MenuResourceDepot;Lcom/android/camera/resourcedata/MenuResourceBase;)V
    ...
    iput v0, p0, Lcom/android/camera/command/LaunchListTypeMenuCommand;->mSlideDirection:I

    .line 44
    iput-object p1, p0, Lcom/android/camera/command/LaunchListTypeMenuCommand;->mActivityContext:Lcom/android/camera/AbstractCameraActivity;

    .line 45
    iput-object p2, p0, Lcom/android/camera/command/LaunchListTypeMenuCommand;->mParentView:Lcom/sec/android/glview/TwGLViewGroup;

    .line 46
    iput-object p3, p0, Lcom/android/camera/command/LaunchListTypeMenuCommand;->mMenuDepot:Lcom/android/camera/MenuResourceDepot;

    .line 47
    iput-object p4, p0, Lcom/android/camera/command/LaunchListTypeMenuCommand;->mResourceData:Lcom/android/camera/resourcedata/MenuResourceBase;
...
.method public execute()V
    ...
    .prologue
    .line 60
    iget-object v1, p0, Lcom/android/camera/command/LaunchListTypeMenuCommand;->mActivityContext:Lcom/android/camera/AbstractCameraActivity;
    ...
    .line 87
    :cond_4
    iget-object v1, p0, Lcom/android/camera/command/LaunchListTypeMenuCommand;->mMenuDepot:Lcom/android/camera/MenuResourceDepot;

    iget-object v1, v1, Lcom/android/camera/MenuResourceDepot;->mMenus:Ljava/util/HashMap;

    iget-object v2, p0, Lcom/android/camera/command/LaunchListTypeMenuCommand;->mResourceData:Lcom/android/camera/resourcedata/MenuResourceBase;
    ...
    iget-object v3, p0, Lcom/android/camera/command/LaunchListTypeMenuCommand;->mParentView:Lcom/sec/android/glview/TwGLViewGroup;

    iget-object v4, p0, Lcom/android/camera/command/LaunchListTypeMenuCommand;->mResourceData:Lcom/android/camera/resourcedata/MenuResourceBase;

    iget-object v5, p0, Lcom/android/camera/command/LaunchListTypeMenuCommand;->mMenuDepot:Lcom/android/camera/MenuResourceDepot;

    iget v6, p0, Lcom/android/camera/command/MenuCommand;->mZOrder:I

    iget v7, p0, Lcom/android/camera/command/LaunchListTypeMenuCommand;->mSlideDirection:I
...
.method public setSliderDirection(I)V
    ...
    .prologue
    .line 55
    iput p1, p0, Lcom/android/camera/command/LaunchListTypeMenuCommand;->mSlideDirection:I
