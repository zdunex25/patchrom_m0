...
java -jar 'other/signapk.jar' '../build/security/platform.x509.pem' '../build/security/platform.pk8' "out/temp/system/app/GuardProvider.apk" "other/signed-GuardProvider.apk"
...
rm -rf system/xbin
zip -q -r "../../unsigned-miuigalaxy-v5-sgs3-ota-to-$version.zip" 'META-INF' 'system'
cd ../..
fi
. ../build/envsetup.sh
cd m0
