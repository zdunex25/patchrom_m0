...
echo '[dwl producent="'samsung'" board="'m0'" tytul="'Samsung&nbsp;Galaxy&nbsp;S3'" android="'4.2.2'" miui="'$version'" data="'$data'" md5="'$md5'" informacje="'$forum'" status="" link="'$LINK_PL'" mirror1="" mirror2="" rozmiar="'$size'" rodzaj="pelna"]
