...
.method public commitBuildprop(Ljava/lang/String;)V
    ...
    invoke-direct {v4, v15, v0}, Lcom/stericson/RootTools/execution/CommandCapture;-><init>(I[Ljava/lang/String;)V

    .line 230
    .local v4, ccSetPermission:Lcom/stericson/RootTools/execution/CommandCapture;
    const/4 v15, 0x1

    :try_start_5
    invoke-static {v15}, Lcom/stericson/RootTools/RootTools;->getShell(Z)Lcom/stericson/RootTools/execution/Shell;

    move-result-object v15

    invoke-virtual {v15, v4}, Lcom/stericson/RootTools/execution/Shell;->add(Lcom/stericson/RootTools/execution/Command;)Lcom/stericson/RootTools/execution/Command;
    :try_end_5
    .catch Ljava/io/IOException; {:try_start_5 .. :try_end_5} :catch_5
    .catch Ljava/util/concurrent/TimeoutException; {:try_start_5 .. :try_end_5} :catch_4
    .catch Lcom/stericson/RootTools/exceptions/RootDeniedException; {:try_start_5 .. :try_end_5} :catch_3
    ...
    .line 185
    .end local v3           #bufferOutput:Ljava/io/BufferedWriter;
    .end local v4           #ccSetPermission:Lcom/stericson/RootTools/execution/CommandCapture;
    .end local v10           #i:I
    .end local v11           #mChmod:Ljava/lang/String;
    .end local v13           #oswOutput:Ljava/io/OutputStreamWriter;
    .restart local v2       #bufferOutput:Ljava/io/BufferedWriter;
