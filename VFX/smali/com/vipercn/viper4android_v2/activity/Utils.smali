...
.method public static copyAssetsToLocal(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Z
    .locals 12
    .parameter "ctx"
    .parameter "mSourceName"
    .parameter "mDestinationName"
...
.method private static installDrv_FX_RootTools(Landroid/content/Context;Ljava/lang/String;)I
    ...
    invoke-direct {v5, v0, v1}, Lcom/stericson/RootTools/execution/CommandCapture;-><init>(I[Ljava/lang/String;)V

    .line 853
    .local v5, ccSetPermission:Lcom/stericson/RootTools/execution/CommandCapture;
    const/16 v17, 0x1

    invoke-static/range {v17 .. v17}, Lcom/stericson/RootTools/RootTools;->getShell(Z)Lcom/stericson/RootTools/execution/Shell;

    move-result-object v17

    move-object/from16 v0, v17

    invoke-virtual {v0, v5}, Lcom/stericson/RootTools/execution/Shell;->add(Lcom/stericson/RootTools/execution/Command;)Lcom/stericson/RootTools/execution/Command;
    ...
    .line 863
    new-instance v4, Lcom/stericson/RootTools/execution/CommandCapture;
    ...
    invoke-direct {v4, v0, v1}, Lcom/stericson/RootTools/execution/CommandCapture;-><init>(I[Ljava/lang/String;)V

    .line 865
    .local v4, ccSetAddondPermission:Lcom/stericson/RootTools/execution/CommandCapture;
    const/16 v17, 0x1
    ...
    invoke-virtual {v0, v4}, Lcom/stericson/RootTools/execution/Shell;->add(Lcom/stericson/RootTools/execution/Command;)Lcom/stericson/RootTools/execution/Command;

    .line 868
    .end local v4           #ccSetAddondPermission:Lcom/stericson/RootTools/execution/CommandCapture;
    :cond_18
    const-string v17, "/system"
    ...
    .line 904
    .restart local v4       #ccSetAddondPermission:Lcom/stericson/RootTools/execution/CommandCapture;
    const/16 v17, 0x1
...
.method public static loadProfileV1(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/content/Context;)Z
    .locals 21
    .parameter "mProfileName"
    .parameter "mProfileDir"
    .parameter "mPreferenceName"
    .parameter "ctx"
...
.method private static modifyFXConfig(Ljava/lang/String;Ljava/lang/String;)I
    .locals 17
    .parameter "mInputFile"
    .parameter "mOutputFile"
    ...
    .line 623
    .end local v8           #inputFileLength:J
    :goto_0
    return v14

    .line 536
    .restart local v8       #inputFileLength:J
    :cond_0
    ...
    .line 541
    .local v7, fosOutput:Ljava/io/FileOutputStream;
    new-instance v10, Ljava/io/InputStreamReader;

    const-string v14, "ASCII"

    invoke-direct {v10, v6, v14}, Ljava/io/InputStreamReader;-><init>(Ljava/io/InputStream;Ljava/lang/String;)V

    .line 542
    .local v10, isrInput:Ljava/io/InputStreamReader;
    new-instance v13, Ljava/io/OutputStreamWriter;

    const-string v14, "ASCII"

    invoke-direct {v13, v7, v14}, Ljava/io/OutputStreamWriter;-><init>(Ljava/io/OutputStream;Ljava/lang/String;)V
    ...
    .line 548
    .local v3, configModified:Z
    long-to-int v14, v8

    invoke-virtual {v1, v14}, Ljava/io/BufferedReader;->mark(I)V
    ...
    .line 563
    .local v11, libraryAppend:Z
    const/4 v5, 0x0

    .line 564
    .local v5, effectAppend:Z
    if-eqz v3, :cond_4
    ...
    .line 552
    .end local v5           #effectAppend:Z
    .end local v11           #libraryAppend:Z
    :cond_2
    ...
    .line 570
    .restart local v5       #effectAppend:Z
    .restart local v11       #libraryAppend:Z
    :cond_3
    ...
    .end local v3           #configModified:Z
    .end local v5           #effectAppend:Z
    .end local v6           #fisInput:Ljava/io/FileInputStream;
    .end local v7           #fosOutput:Ljava/io/FileOutputStream;
    .end local v8           #inputFileLength:J
    .end local v10           #isrInput:Ljava/io/InputStreamReader;
    .end local v11           #libraryAppend:Z
    ...
    .restart local v3       #configModified:Z
    .restart local v5       #effectAppend:Z
    .restart local v6       #fisInput:Ljava/io/FileInputStream;
    .restart local v7       #fosOutput:Ljava/io/FileOutputStream;
    .restart local v8       #inputFileLength:J
    .restart local v10       #isrInput:Ljava/io/InputStreamReader;
    .restart local v11       #libraryAppend:Z
    .restart local v12       #mLine:Ljava/lang/String;
