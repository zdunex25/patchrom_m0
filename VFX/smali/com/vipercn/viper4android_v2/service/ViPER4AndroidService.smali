...
.method public onCreate()V
    ...
    const-string v2, "Query ViPER4Android engine ..."

    invoke-static {v1, v2}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    .line 1175
    new-instance v7, Lcom/vipercn/viper4android_v2/activity/Utils$AudioEffectUtils;

    new-instance v1, Lcom/vipercn/viper4android_v2/activity/Utils;

    invoke-direct {v1}, Lcom/vipercn/viper4android_v2/activity/Utils;-><init>()V

    invoke-virtual {v1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-direct {v7, v1}, Lcom/vipercn/viper4android_v2/activity/Utils$AudioEffectUtils;-><init>(Lcom/vipercn/viper4android_v2/activity/Utils;)V

    .line 1176
    .local v7, aeuUtils:Lcom/vipercn/viper4android_v2/activity/Utils$AudioEffectUtils;
    invoke-virtual {v7}, Lcom/vipercn/viper4android_v2/activity/Utils$AudioEffectUtils;->isViPER4AndroidEngineFound()Z
    ...
    const-string v2, "ViPER4Android engine not found, create empty service"
    ...
    iput-boolean v1, v0, Lcom/vipercn/viper4android_v2/service/ViPER4AndroidService;->mDriverIsReady:Z
    ...
    .line 1182
    :cond_0
    invoke-virtual {v7}, Lcom/vipercn/viper4android_v2/activity/Utils$AudioEffectUtils;->getViper4AndroidEngineVersion()[I

    move-result-object v11

    .line 1183
    .local v11, iaDrvVer:[I
    ...
    .line 1185
    .local v15, mDriverVersion:Ljava/lang/String;
    const/4 v7, 0x0

    .line 1186
    invoke-static {v15}, Lcom/vipercn/viper4android_v2/activity/ViPER4Android;->isDriverCompatible(Ljava/lang/String;)Z
    ...
    const-string v2, "ViPER4Android engine is not compatible with service"
    ...
    const-string v2, "Current is a2dp mode [bluetooth]"
    ...
    sput-boolean v1, Lcom/vipercn/viper4android_v2/service/ViPER4AndroidService;->mUseUSB:Z
    ...
    const-string v3, "Get current mode from system ["
    ...
    invoke-virtual {v0, v3, v4}, Lcom/vipercn/viper4android_v2/service/ViPER4AndroidService;->getSharedPreferences(Ljava/lang/String;I)Landroid/content/SharedPreferences;
    ...
    iget-object v1, v0, Lcom/vipercn/viper4android_v2/service/ViPER4AndroidService;->mGeneralFX:Lcom/vipercn/viper4android_v2/service/ViPER4AndroidService$V4ADSPModule;
    ...
    const-string v2, "onCreate, mGeneralFX != null"
    ...
    iput-object v1, v0, Lcom/vipercn/viper4android_v2/service/ViPER4AndroidService;->mGeneralFX:Lcom/vipercn/viper4android_v2/service/ViPER4AndroidService$V4ADSPModule;

    .line 1223
    :cond_3
    const-string v1, "com.vipercn.viper4android_v2.settings"
    ...
    invoke-virtual {v0, v1, v2}, Lcom/vipercn/viper4android_v2/service/ViPER4AndroidService;->getSharedPreferences(Ljava/lang/String;I)Landroid/content/SharedPreferences;

    move-result-object v16

    .line 1225
    .local v16, prefSettings:Landroid/content/SharedPreferences;
    ...
    .line 1228
    .local v10, editPrefs:Landroid/content/SharedPreferences$Editor;
    if-eqz v10, :cond_4
    ...
    .line 1234
    .end local v10           #editPrefs:Landroid/content/SharedPreferences$Editor;
    :cond_4
    ...
    .line 1235
    .local v13, mCompatibleMode:Ljava/lang/String;
    ...
    const-string v2, "Creating global V4ADSPModule ..."
    ...
    .line 1238
    new-instance v1, Lcom/vipercn/viper4android_v2/service/ViPER4AndroidService$V4ADSPModule;

    const/4 v2, 0x0

    move-object/from16 v0, p0

    invoke-direct {v1, v0, v2}, Lcom/vipercn/viper4android_v2/service/ViPER4AndroidService$V4ADSPModule;-><init>(Lcom/vipercn/viper4android_v2/service/ViPER4AndroidService;I)V
    ...
    iget-object v1, v1, Lcom/vipercn/viper4android_v2/service/ViPER4AndroidService$V4ADSPModule;->mInstance:Landroid/media/audiofx/AudioEffect;
    ...
    const-string v2, "Found v4a driver, but failed to load."
    ...
    invoke-virtual {v0, v1, v2}, Lcom/vipercn/viper4android_v2/service/ViPER4AndroidService;->startForeground(ILandroid/app/Notification;)V
    ...
    .line 1251
    .local v9, audioSessionFilter:Landroid/content/IntentFilter;
    ...
    iget-object v1, v0, Lcom/vipercn/viper4android_v2/service/ViPER4AndroidService;->mAudioSessionReceiver:Landroid/content/BroadcastReceiver;

    move-object/from16 v0, p0

    invoke-virtual {v0, v1, v9}, Lcom/vipercn/viper4android_v2/service/ViPER4AndroidService;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;
    ...
    .line 1256
    .local v8, audioFilter:Landroid/content/IntentFilter;
    ...
    iget-object v1, v0, Lcom/vipercn/viper4android_v2/service/ViPER4AndroidService;->mRoutingReceiver:Landroid/content/BroadcastReceiver;

    move-object/from16 v0, p0

    invoke-virtual {v0, v1, v8}, Lcom/vipercn/viper4android_v2/service/ViPER4AndroidService;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;

    .line 1265
    move-object/from16 v0, p0

    iget-object v1, v0, Lcom/vipercn/viper4android_v2/service/ViPER4AndroidService;->mPreferenceUpdateReceiver:Landroid/content/BroadcastReceiver;

    .line 1266
    new-instance v2, Landroid/content/IntentFilter;

    const-string v3, "com.vipercn.viper4android_v2.UPDATE"
    ...
    invoke-virtual {v0, v1, v2}, Lcom/vipercn/viper4android_v2/service/ViPER4AndroidService;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;

    .line 1267
    move-object/from16 v0, p0

    iget-object v1, v0, Lcom/vipercn/viper4android_v2/service/ViPER4AndroidService;->mShowNotifyReceiver:Landroid/content/BroadcastReceiver;

    new-instance v2, Landroid/content/IntentFilter;

    const-string v3, "com.vipercn.viper4android_v2.SHOWNOTIFY"
    ...
    iget-object v1, v0, Lcom/vipercn/viper4android_v2/service/ViPER4AndroidService;->mCancelNotifyReceiver:Landroid/content/BroadcastReceiver;

    .line 1269
    new-instance v2, Landroid/content/IntentFilter;

    const-string v3, "com.vipercn.viper4android_v2.CANCELNOTIFY"
    ...
    iget-object v1, v0, Lcom/vipercn/viper4android_v2/service/ViPER4AndroidService;->m3rdAPI_QUERY_DRIVERSTATUS_Receiver:Landroid/content/BroadcastReceiver;

    .line 1273
    new-instance v2, Landroid/content/IntentFilter;

    const-string v3, "com.vipercn.viper4android_v2.QUERY_DRIVERSTATUS"
    ...
    iget-object v1, v0, Lcom/vipercn/viper4android_v2/service/ViPER4AndroidService;->m3rdAPI_QUERY_EQUALIZER_Receiver:Landroid/content/BroadcastReceiver;

    .line 1275
    new-instance v2, Landroid/content/IntentFilter;

    const-string v3, "com.vipercn.viper4android_v2.QUERY_EQUALIZER"
    ...
    iget-object v1, v0, Lcom/vipercn/viper4android_v2/service/ViPER4AndroidService;->m3rdAPI_TAKEOVER_EFFECT_Receiver:Landroid/content/BroadcastReceiver;

    .line 1277
    new-instance v2, Landroid/content/IntentFilter;

    const-string v3, "com.vipercn.viper4android_v2.TAKEOVER_EFFECT"
    ...
    iget-object v1, v0, Lcom/vipercn/viper4android_v2/service/ViPER4AndroidService;->m3rdAPI_RELEASE_EFFECT_Receiver:Landroid/content/BroadcastReceiver;

    new-instance v2, Landroid/content/IntentFilter;

    const-string v3, "com.vipercn.viper4android_v2.RELEASE_EFFECT"
    ...
    iget-object v1, v0, Lcom/vipercn/viper4android_v2/service/ViPER4AndroidService;->m3rdAPI_SET_ENABLED_Receiver:Landroid/content/BroadcastReceiver;

    new-instance v2, Landroid/content/IntentFilter;

    const-string v3, "com.vipercn.viper4android_v2.SET_ENABLED"
    ...
    iget-object v1, v0, Lcom/vipercn/viper4android_v2/service/ViPER4AndroidService;->m3rdAPI_SET_EQUALIZER_Receiver:Landroid/content/BroadcastReceiver;

    new-instance v2, Landroid/content/IntentFilter;

    const-string v3, "com.vipercn.viper4android_v2.SET_EQUALIZER"
    ...
    const-string v2, "Service launched."
    ...
    iget-object v1, v0, Lcom/vipercn/viper4android_v2/service/ViPER4AndroidService;->mediaStatusTimer:Ljava/util/Timer;

    move-object/from16 v0, p0

    iget-object v2, v0, Lcom/vipercn/viper4android_v2/service/ViPER4AndroidService;->mediaTimerTask:Ljava/util/TimerTask;
    ...
    .line 1202
    .end local v8           #audioFilter:Landroid/content/IntentFilter;
    .end local v9           #audioSessionFilter:Landroid/content/IntentFilter;
    .end local v13           #mCompatibleMode:Ljava/lang/String;
    .end local v14           #mDriverConfigured:Z
    .end local v16           #prefSettings:Landroid/content/SharedPreferences;
    :cond_9
    ...
    const-string v2, "Current is headset mode"
    ...
    const-string v2, "Current is speaker mode"
