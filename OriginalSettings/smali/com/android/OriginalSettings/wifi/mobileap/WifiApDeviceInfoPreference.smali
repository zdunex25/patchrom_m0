...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/OriginalSettings/wifi/mobileap/WifiApDeviceInfoPreference;->TAG:Ljava/lang/String;
...
.method public constructor <init>(Lcom/android/OriginalSettings/SettingsPreferenceFragment;Landroid/net/wifi/WifiConfiguration;)V
    ...
    iput-object v0, p0, Lcom/android/OriginalSettings/wifi/mobileap/WifiApDeviceInfoPreference;->mContext:Landroid/content/Context;
    ...
    .line 66
    :goto_0
    invoke-direct {p0}, Lcom/android/OriginalSettings/wifi/mobileap/WifiApDeviceInfoPreference;->updateSummary()V
...
.method static synthetic access$000(Lcom/android/OriginalSettings/wifi/mobileap/WifiApDeviceInfoPreference;)V
    .locals 0
    .parameter "x0"
...
.method static synthetic access$100(Lcom/android/OriginalSettings/wifi/mobileap/WifiApDeviceInfoPreference;)V
    ...
    .prologue
    .line 32
    invoke-direct {p0}, Lcom/android/OriginalSettings/wifi/mobileap/WifiApDeviceInfoPreference;->checkConnectedDeviceOrChangeAllowPolicy()V
...
.method private changeAllowPolicy()V
    ...
    .line 145
    iget-object v1, p0, Lcom/android/OriginalSettings/wifi/mobileap/WifiApDeviceInfoPreference;->mContext:Landroid/content/Context;
...
.method private checkConnectedDeviceOrChangeAllowPolicy()V
    ...
    .line 126
    iget-object v3, p0, Lcom/android/OriginalSettings/wifi/mobileap/WifiApDeviceInfoPreference;->mContext:Landroid/content/Context;
    ...
    invoke-direct {p0, v3}, Lcom/android/OriginalSettings/wifi/mobileap/WifiApDeviceInfoPreference;->showDialog(I)V
...
.method private showDialog(I)V
    ...
    iget-object v2, p0, Lcom/android/OriginalSettings/wifi/mobileap/WifiApDeviceInfoPreference;->mContext:Landroid/content/Context;
    ...
    new-instance v4, Lcom/android/OriginalSettings/wifi/mobileap/WifiApDeviceInfoPreference$2;

    invoke-direct {v4, p0}, Lcom/android/OriginalSettings/wifi/mobileap/WifiApDeviceInfoPreference$2;-><init>(Lcom/android/OriginalSettings/wifi/mobileap/WifiApDeviceInfoPreference;)V

    invoke-virtual {v2, v3, v4}, Landroid/app/AlertDialog$Builder;->setPositiveButton(ILandroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog$Builder;

    move-result-object v2

    new-instance v3, Lcom/android/OriginalSettings/wifi/mobileap/WifiApDeviceInfoPreference$1;

    invoke-direct {v3, p0}, Lcom/android/OriginalSettings/wifi/mobileap/WifiApDeviceInfoPreference$1;-><init>(Lcom/android/OriginalSettings/wifi/mobileap/WifiApDeviceInfoPreference;)V
    ...
    .line 103
    :pswitch_1
    iget-boolean v2, p0, Lcom/android/OriginalSettings/wifi/mobileap/WifiApDeviceInfoPreference;->mAllowAll:Z
    ...
    new-instance v4, Lcom/android/OriginalSettings/wifi/mobileap/WifiApDeviceInfoPreference$4;

    invoke-direct {v4, p0, v0}, Lcom/android/OriginalSettings/wifi/mobileap/WifiApDeviceInfoPreference$4;-><init>(Lcom/android/OriginalSettings/wifi/mobileap/WifiApDeviceInfoPreference;I)V
...
.method private updateSummary()V
    ...
    .prologue
    .line 135
    sget-object v0, Lcom/android/OriginalSettings/wifi/mobileap/WifiApDeviceInfoPreference;->TAG:Ljava/lang/String;
    ...
    .line 136
    iget-boolean v0, p0, Lcom/android/OriginalSettings/wifi/mobileap/WifiApDeviceInfoPreference;->mAllowAll:Z
...
.method public onClickItem(Landroid/net/wifi/WifiConfiguration;)V
    ...
    .prologue
    .line 80
    iput-object p1, p0, Lcom/android/OriginalSettings/wifi/mobileap/WifiApDeviceInfoPreference;->mWifiConfig:Landroid/net/wifi/WifiConfiguration;

    .line 81
    const/4 v0, 0x2

    invoke-direct {p0, v0}, Lcom/android/OriginalSettings/wifi/mobileap/WifiApDeviceInfoPreference;->showDialog(I)V
...
.method public updateSsid(Ljava/lang/String;)V
    ...
    .prologue
    .line 75
    invoke-virtual {p0, p1}, Lcom/android/OriginalSettings/wifi/mobileap/WifiApDeviceInfoPreference;->setTitle(Ljava/lang/CharSequence;)V

    .line 76
    invoke-virtual {p0}, Lcom/android/OriginalSettings/wifi/mobileap/WifiApDeviceInfoPreference;->notifyHierarchyChanged()V
