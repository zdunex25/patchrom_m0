.class public Lcom/android/OriginalSettings/users/UserSettings;
...
.method private onAddUserClicked()V
    ...
    .line 76
    invoke-virtual {p0}, Lcom/android/OriginalSettings/users/UserSettings;->getActivity()Landroid/app/Activity;

    move-result-object v0

    check-cast v0, Lmiui/preference/BasePreferenceActivity;

    const-class v1, Lcom/android/OriginalSettings/users/UserDetailsSettings;
...
.method private updateUserList()V
    ...
    iget-object v4, p0, Lcom/android/OriginalSettings/users/UserSettings;->mUserListCategory:Landroid/preference/PreferenceGroup;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/OriginalSettings/users/UserSettings;->addPreferencesFromResource(I)V

    .line 46
    const-string v0, "user_list"

    invoke-virtual {p0, v0}, Lcom/android/OriginalSettings/users/UserSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;

    move-result-object v0

    check-cast v0, Landroid/preference/PreferenceGroup;

    iput-object v0, p0, Lcom/android/OriginalSettings/users/UserSettings;->mUserListCategory:Landroid/preference/PreferenceGroup;

    .line 48
    const/4 v0, 0x1

    invoke-virtual {p0, v0}, Lcom/android/OriginalSettings/users/UserSettings;->setHasOptionsMenu(Z)V
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    .line 68
    invoke-direct {p0}, Lcom/android/OriginalSettings/users/UserSettings;->onAddUserClicked()V
...
.method public onResume()V
    ...
    .line 54
    invoke-direct {p0}, Lcom/android/OriginalSettings/users/UserSettings;->updateUserList()V
