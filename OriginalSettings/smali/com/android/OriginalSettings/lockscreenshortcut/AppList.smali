...
.method static constructor <clinit>()V
    ...
    sput v0, Lcom/android/OriginalSettings/lockscreenshortcut/AppList;->MAX_SHORTCUT_ICON:I
...
.method public constructor <init>()V
    ...
    .line 52
    iput v3, p0, Lcom/android/OriginalSettings/lockscreenshortcut/AppList;->mNumOfSavedShortcut:I

    .line 53
    iput v3, p0, Lcom/android/OriginalSettings/lockscreenshortcut/AppList;->mClickedViewIndex:I
    ...
    iput-object v0, p0, Lcom/android/OriginalSettings/lockscreenshortcut/AppList;->mSetedShortcut_package:[Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/android/OriginalSettings/lockscreenshortcut/AppList;->mSetedShortcut_activity:[Ljava/lang/String;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v0, v2}, Lcom/android/OriginalSettings/lockscreenshortcut/AppList;->setResult(I)V

    .line 65
    invoke-virtual/range {p0 .. p0}, Lcom/android/OriginalSettings/lockscreenshortcut/AppList;->getIntent()Landroid/content/Intent;
    ...
    iput v2, v0, Lcom/android/OriginalSettings/lockscreenshortcut/AppList;->mNumOfSavedShortcut:I
    ...
    iput v2, v0, Lcom/android/OriginalSettings/lockscreenshortcut/AppList;->mClickedViewIndex:I
    ...
    sput v2, Lcom/android/OriginalSettings/lockscreenshortcut/AppList;->MAX_SHORTCUT_ICON:I

    .line 71
    move-object/from16 v0, p0

    iget v2, v0, Lcom/android/OriginalSettings/lockscreenshortcut/AppList;->mNumOfSavedShortcut:I

    sget v3, Lcom/android/OriginalSettings/lockscreenshortcut/AppList;->MAX_SHORTCUT_ICON:I

    if-le v2, v3, :cond_0

    .line 72
    sget v2, Lcom/android/OriginalSettings/lockscreenshortcut/AppList;->MAX_SHORTCUT_ICON:I
    ...
    iget-object v2, v0, Lcom/android/OriginalSettings/lockscreenshortcut/AppList;->mSetedShortcut_package:[Ljava/lang/String;
    ...
    iget-object v2, v0, Lcom/android/OriginalSettings/lockscreenshortcut/AppList;->mSetedShortcut_activity:[Ljava/lang/String;
    ...
    :cond_1
    invoke-virtual/range {p0 .. p0}, Lcom/android/OriginalSettings/lockscreenshortcut/AppList;->getPackageManager()Landroid/content/pm/PackageManager;

    move-result-object v2

    move-object/from16 v0, p0

    iput-object v2, v0, Lcom/android/OriginalSettings/lockscreenshortcut/AppList;->mPm:Landroid/content/pm/PackageManager;
    ...
    iget-object v2, v0, Lcom/android/OriginalSettings/lockscreenshortcut/AppList;->mPm:Landroid/content/pm/PackageManager;
    ...
    new-instance v10, Lcom/android/OriginalSettings/lockscreenshortcut/AppList$AlphaComparator;

    move-object/from16 v0, p0

    invoke-direct {v10, v0}, Lcom/android/OriginalSettings/lockscreenshortcut/AppList$AlphaComparator;-><init>(Lcom/android/OriginalSettings/lockscreenshortcut/AppList;)V

    .line 97
    .local v10, alphaComparator:Lcom/android/OriginalSettings/lockscreenshortcut/AppList$AlphaComparator;
    ...
    iput-object v2, v0, Lcom/android/OriginalSettings/lockscreenshortcut/AppList;->mIconCache:Ljava/util/HashMap;
    ...
    iget-object v3, v0, Lcom/android/OriginalSettings/lockscreenshortcut/AppList;->mIconCache:Ljava/util/HashMap;
    ...
    iget-object v5, v0, Lcom/android/OriginalSettings/lockscreenshortcut/AppList;->mPm:Landroid/content/pm/PackageManager;
    ...
    .line 112
    :cond_5
    new-instance v2, Lcom/android/OriginalSettings/lockscreenshortcut/AppList$AppListAdapter;
    ...
    invoke-direct/range {v2 .. v7}, Lcom/android/OriginalSettings/lockscreenshortcut/AppList$AppListAdapter;-><init>(Lcom/android/OriginalSettings/lockscreenshortcut/AppList;Landroid/content/Context;IILjava/util/List;)V

    move-object/from16 v0, p0

    iput-object v2, v0, Lcom/android/OriginalSettings/lockscreenshortcut/AppList;->mAppListAdapter:Lcom/android/OriginalSettings/lockscreenshortcut/AppList$AppListAdapter;

    .line 114
    invoke-virtual/range {p0 .. p0}, Lcom/android/OriginalSettings/lockscreenshortcut/AppList;->getListView()Landroid/widget/ListView;
    ...
    iget-object v2, v0, Lcom/android/OriginalSettings/lockscreenshortcut/AppList;->mAppListAdapter:Lcom/android/OriginalSettings/lockscreenshortcut/AppList$AppListAdapter;
