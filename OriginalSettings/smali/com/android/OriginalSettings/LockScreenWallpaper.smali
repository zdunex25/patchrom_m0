...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/OriginalSettings/LockScreenWallpaper$ItemLongClickListener;,
...
.field private mAdapter:Lcom/android/OriginalSettings/LockScreenWallpaper$WallpaperAdapter;
...
.method static synthetic access$000(Lcom/android/OriginalSettings/LockScreenWallpaper;)Ljava/util/List;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$100(Lcom/android/OriginalSettings/LockScreenWallpaper;)Z
    .locals 1
    .parameter "x0"
...
.method static synthetic access$200(Lcom/android/OriginalSettings/LockScreenWallpaper;)Landroid/view/LayoutInflater;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$300(Lcom/android/OriginalSettings/LockScreenWallpaper;)I
    .locals 1
    .parameter "x0"

    .prologue
    .line 45
    iget v0, p0, Lcom/android/OriginalSettings/LockScreenWallpaper;->mIconSize:I

    return v0
.end method

.method static synthetic access$400(Lcom/android/OriginalSettings/LockScreenWallpaper;)Landroid/content/pm/PackageManager;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$500(Lcom/android/OriginalSettings/LockScreenWallpaper;)[Ljava/lang/String;
    .locals 1
    .parameter "x0"
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v4}, Lcom/android/OriginalSettings/LockScreenWallpaper;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v4

    check-cast v4, Landroid/view/LayoutInflater;

    iput-object v4, p0, Lcom/android/OriginalSettings/LockScreenWallpaper;->mInflater:Landroid/view/LayoutInflater;
    ...
    iput-boolean v4, p0, Lcom/android/OriginalSettings/LockScreenWallpaper;->mDirectWallpaper:Z
    ...
    iget-boolean v4, p0, Lcom/android/OriginalSettings/LockScreenWallpaper;->mDirectWallpaper:Z
    ...
    iput-object v4, p0, Lcom/android/OriginalSettings/LockScreenWallpaper;->mPm:Landroid/content/pm/PackageManager;
    ...
    iget-object v4, p0, Lcom/android/OriginalSettings/LockScreenWallpaper;->mPm:Landroid/content/pm/PackageManager;
    ...
    iput-object v4, p0, Lcom/android/OriginalSettings/LockScreenWallpaper;->rList:Ljava/util/List;

    .line 88
    new-instance v2, Lcom/android/OriginalSettings/LockScreenWallpaper$AlphaComparator;

    invoke-direct {v2, p0}, Lcom/android/OriginalSettings/LockScreenWallpaper$AlphaComparator;-><init>(Lcom/android/OriginalSettings/LockScreenWallpaper;)V

    .line 89
    .local v2, mAlphaComparator:Lcom/android/OriginalSettings/LockScreenWallpaper$AlphaComparator;
    iget-object v4, p0, Lcom/android/OriginalSettings/LockScreenWallpaper;->rList:Ljava/util/List;
    ...
    iput v4, p0, Lcom/android/OriginalSettings/LockScreenWallpaper;->mIconSize:I

    .line 94
    iget-object v1, p0, Lcom/android/OriginalSettings/LockScreenWallpaper;->mAlertParams:Lcom/android/internal/app/AlertController$AlertParams;
    ...
    .line 97
    invoke-virtual {p0}, Lcom/android/OriginalSettings/LockScreenWallpaper;->getLayoutInflater()Landroid/view/LayoutInflater;
    ...
    iput-object v4, p0, Lcom/android/OriginalSettings/LockScreenWallpaper;->mGrid:Landroid/widget/GridView;

    .line 99
    new-instance v4, Lcom/android/OriginalSettings/LockScreenWallpaper$WallpaperAdapter;

    invoke-direct {v4, p0, p0}, Lcom/android/OriginalSettings/LockScreenWallpaper$WallpaperAdapter;-><init>(Lcom/android/OriginalSettings/LockScreenWallpaper;Landroid/content/Context;)V

    iput-object v4, p0, Lcom/android/OriginalSettings/LockScreenWallpaper;->mAdapter:Lcom/android/OriginalSettings/LockScreenWallpaper$WallpaperAdapter;

    .line 100
    iget-object v4, p0, Lcom/android/OriginalSettings/LockScreenWallpaper;->mGrid:Landroid/widget/GridView;

    iget-object v5, p0, Lcom/android/OriginalSettings/LockScreenWallpaper;->mAdapter:Lcom/android/OriginalSettings/LockScreenWallpaper$WallpaperAdapter;
    ...
    new-instance v5, Lcom/android/OriginalSettings/LockScreenWallpaper$ItemLongClickListener;

    invoke-direct {v5, p0}, Lcom/android/OriginalSettings/LockScreenWallpaper$ItemLongClickListener;-><init>(Lcom/android/OriginalSettings/LockScreenWallpaper;)V
    ...
    .line 103
    invoke-virtual {p0}, Lcom/android/OriginalSettings/LockScreenWallpaper;->resizeGrid()V
...
.method public onItemClick(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    :goto_1
    invoke-virtual {p0}, Lcom/android/OriginalSettings/LockScreenWallpaper;->finish()V
...
.method resizeGrid()V
    ...
    .prologue
    .line 248
    iget-object v2, p0, Lcom/android/OriginalSettings/LockScreenWallpaper;->mAdapter:Lcom/android/OriginalSettings/LockScreenWallpaper$WallpaperAdapter;

    invoke-virtual {v2}, Lcom/android/OriginalSettings/LockScreenWallpaper$WallpaperAdapter;->getCount()I
    ...
    iget-object v2, p0, Lcom/android/OriginalSettings/LockScreenWallpaper;->mGrid:Landroid/widget/GridView;
