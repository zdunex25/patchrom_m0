...
.method private getFrontResumedActivities(ZZ)Ljava/util/ArrayList;
    ...
    .line 4123
    .local v1, frontActivities:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/server/am/ActivityRecord;>;"
    monitor-enter p0
    ...
    :goto_1
    invoke-static {v8, v9, v6, p1}, Landroid/sec/multiwindow/impl/MultiWindowManager;->isArrangeMode(IZZZ)Z
...
.method private shouldHideActivity(ZIILcom/android/server/am/ActivityRecord;)Z
    ...
    .prologue
    .line 1545
    iget v1, p4, Lcom/android/server/am/ActivityRecord;->currentWindowMode:I
...
.method final moveTaskToFrontLocked(Lcom/android/server/am/TaskRecord;Lcom/android/server/am/ActivityRecord;Landroid/os/Bundle;I)V
    ...
    iget v15, v0, Lcom/android/server/am/TaskRecord;->taskId:I
    ...
    .line 5147
    .local v8, moved:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Landroid/os/IBinder;>;"
    move-object/from16 v0, p0
    ...
    .line 5152
    .local v11, pinupmoved:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Landroid/os/IBinder;>;"
    const/4 v4, 0x0
    ...
    iget-boolean v0, v13, Lcom/android/server/am/ActivityRecord;->isHomeActivity:Z
    ...
    invoke-virtual {v9, v13, v0}, Lcom/android/server/am/MultiWindowManagerService;->updateSplitZone(Lcom/android/server/am/ActivityRecord;Ljava/util/ArrayList;)V
    ...
    const-string v20, "android.intent.extra.WINDOW_POSITION"

    invoke-virtual/range {v19 .. v20}, Landroid/content/Intent;->getExtra(Ljava/lang/String;)Ljava/lang/Object;
    ...
    .line 5205
    .local v18, windowPosition:Landroid/graphics/Rect;
    if-eqz v18, :cond_a
    ...
    .end local v18           #windowPosition:Landroid/graphics/Rect;
    :cond_a
    iget-object v0, v13, Lcom/android/server/am/ActivityRecord;->task:Lcom/android/server/am/TaskRecord;
    ...
    invoke-virtual {v0, v8}, Lcom/android/server/wm/WindowManagerService;->moveAppTokensToTop(Ljava/util/List;)V
    ...
    invoke-direct {v0, v15}, Lcom/android/server/am/ActivityStack;->finishTaskMoveLocked(I)V
...
.method public final screenshotActivities(Lcom/android/server/am/ActivityRecord;)Landroid/graphics/Bitmap;
    ...
    .line 1083
    invoke-static {}, Lcom/android/server/am/FlashBoardManagerService;->getSelf()Lcom/android/server/am/FlashBoardManagerService;

    move-result-object v4

    invoke-virtual {v4}, Lcom/android/server/am/FlashBoardManagerService;->getEnable()Z
...
.method final startActivityLocked(Landroid/app/IApplicationThread;Landroid/content/Intent;Ljava/lang/String;Landroid/content/pm/ActivityInfo;Landroid/os/IBinder;Ljava/lang/String;IIIILandroid/os/Bundle;Z[Lcom/android/server/am/ActivityRecord;)I
    ...
    .line 2996
    .local v38, oldPolicy:Landroid/os/StrictMode$ThreadPolicy;
    ...
    .line 3003
    .local v42, rp:Landroid/app/enterprise/IRestrictionPolicy;
    if-eqz v42, :cond_3
    ...
    aget-object v28, v22, v29

    .line 3010
    .local v28, exception:Ljava/lang/String;
    move-object/from16 v0, v21
    ...
    .line 3015
    .end local v28           #exception:Ljava/lang/String;
    :cond_2
    if-eqz v31, :cond_8
    ...
    .end local v29           #i$:I
    .end local v31           #isActivityAllowed:Z
    .end local v35           #len$:I
    .end local v42           #rp:Landroid/app/enterprise/IRestrictionPolicy;
    :cond_3
    :goto_2
    ...
    .end local v38           #oldPolicy:Landroid/os/StrictMode$ThreadPolicy;
    :cond_6
    const-string v3, "ActivityManager"
    ...
    .restart local v28       #exception:Ljava/lang/String;
    .restart local v29       #i$:I
    .restart local v31       #isActivityAllowed:Z
    .restart local v35       #len$:I
    .restart local v38       #oldPolicy:Landroid/os/StrictMode$ThreadPolicy;
    .restart local v42       #rp:Landroid/app/enterprise/IRestrictionPolicy;
    :cond_7
    ...
    .line 3032
    .local v33, km:Landroid/app/enterprise/kioskmode/IKioskMode;
    if-eqz v33, :cond_3
    ...
    .line 3036
    .end local v33           #km:Landroid/app/enterprise/kioskmode/IKioskMode;
    :catch_1
    move-exception v26
    ...
    .line 3043
    .local v41, pwdPolicy:Landroid/app/enterprise/IPasswordPolicy;
    if-eqz v41, :cond_3

    invoke-interface/range {v41 .. v41}, Landroid/app/enterprise/IPasswordPolicy;->isChangeRequested()I
    ...
    .line 3045
    .local v36, list:Ljava/util/List;
    if-eqz v36, :cond_3
    ...
    .line 3047
    .local v45, topActivity:Ljava/lang/String;
    const/16 v31, 0x0
    ...
    .line 3049
    .local v32, isTopActivityException:Z
    invoke-virtual/range {v24 .. v24}, Landroid/content/ComponentName;->getClassName()Ljava/lang/String;
    ...
    .end local v29           #i$:I
    .end local v31           #isActivityAllowed:Z
    .end local v32           #isTopActivityException:Z
    .end local v35           #len$:I
    .end local v36           #list:Ljava/util/List;
    .end local v41           #pwdPolicy:Landroid/app/enterprise/IPasswordPolicy;
    .end local v45           #topActivity:Ljava/lang/String;
    :catch_2
    move-exception v26
    ...
    .line 3186
    .local v47, watchIntent:Landroid/content/Intent;
    move-object/from16 v0, p0
    ...
    .line 3192
    .end local v47           #watchIntent:Landroid/content/Intent;
    :goto_a
    if-eqz v20, :cond_1c
    ...
    .line 3186
    .restart local v47       #watchIntent:Landroid/content/Intent;
    :cond_1b
    const/16 v20, 0x0
    ...
    .line 3214
    .local v40, parentActivityRecord:Lcom/android/server/am/ActivityRecord;
    if-eqz v43, :cond_22
    ...
    .line 3244
    new-instance v39, Lcom/android/server/am/ActivityManagerService$PendingActivityLaunch;

    invoke-direct/range {v39 .. v39}, Lcom/android/server/am/ActivityManagerService$PendingActivityLaunch;-><init>()V

    .line 3245
    .local v39, pal:Lcom/android/server/am/ActivityManagerService$PendingActivityLaunch;
    ...
    .end local v39           #pal:Lcom/android/server/am/ActivityManagerService$PendingActivityLaunch;
    :cond_22
    if-eqz v23, :cond_1e
    ...
    .end local v40           #parentActivityRecord:Lcom/android/server/am/ActivityRecord;
    check-cast v40, Lcom/android/server/am/ActivityRecord;

    .restart local v40       #parentActivityRecord:Lcom/android/server/am/ActivityRecord;
    goto/16 :goto_b
