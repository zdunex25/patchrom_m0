...
.method constructor <init>(Lcom/android/server/am/ActivityManagerService;Lcom/android/server/am/ActivityStack;Lcom/android/server/am/ProcessRecord;ILandroid/content/Intent;Ljava/lang/String;Landroid/content/pm/ActivityInfo;Landroid/content/res/Configuration;Lcom/android/server/am/ActivityRecord;Ljava/lang/String;IZI)V
    ...
    invoke-direct {v8, p0}, Lcom/android/server/am/ActivityRecord$Token;-><init>(Lcom/android/server/am/ActivityRecord;)V
    ...
    iput-boolean v8, p0, Lcom/android/server/am/ActivityRecord;->configDestroy:Z
    ...
    iput-boolean v8, p0, Lcom/android/server/am/ActivityRecord;->waitingVisible:Z
    ...
    iput-boolean v8, p0, Lcom/android/server/am/ActivityRecord;->thumbnailNeeded:Z
    ...
    iput-object v8, p0, Lcom/android/server/am/ActivityRecord;->baseDir:Ljava/lang/String;
    ...
    iput-object v8, p0, Lcom/android/server/am/ActivityRecord;->resDir:Ljava/lang/String;
    ...
    iput-object v8, p0, Lcom/android/server/am/ActivityRecord;->dataDir:Ljava/lang/String;
    ...
    iget-object v8, v1, Landroid/content/pm/ApplicationInfo;->nonLocalizedLabel:Ljava/lang/CharSequence;

    iput-object v8, p0, Lcom/android/server/am/ActivityRecord;->nonLocalizedLabel:Ljava/lang/CharSequence;

    .line 431
    iget v8, v1, Landroid/content/pm/ApplicationInfo;->labelRes:I
    ...
    .line 449
    :cond_4
    iget-object v8, p3, Lcom/android/server/am/ProcessRecord;->processName:Ljava/lang/String;
    ...
    invoke-virtual {v8, v9, v10, v11}, Lcom/android/server/AttributeCache;->get(Ljava/lang/String;I[I)Lcom/android/server/AttributeCache$Entry;
    ...
    iget-object v8, v3, Lcom/android/server/AttributeCache$Entry;->array:Landroid/content/res/TypedArray;
    ...
    const-class v8, Lcom/android/internal/app/ResolverActivity;
    ...
    iput-boolean v8, p0, Lcom/android/server/am/ActivityRecord;->isHomeActivity:Z
    ...
    iget-boolean v8, v8, Lcom/android/server/am/ActivityStack;->mIsMultiWindowEnabled:Z
    ...
    iput v8, p0, Lcom/android/server/am/ActivityRecord;->currentWindowMode:I
    ...
    .line 525
    .local v4, supportAllApps:Z
    const/4 v5, 0x0

    .line 527
    .local v5, supportMultiWindow:Z
    move/from16 v0, p13

    iput v0, p0, Lcom/android/server/am/ActivityRecord;->currentWindowMode:I

    .line 528
    iget-object v8, p0, Lcom/android/server/am/ActivityRecord;->info:Landroid/content/pm/ActivityInfo;
    ...
    .line 537
    :cond_13
    const-string v8, "com.sec.android.multiwindow.STYLE"
    ...
    .line 538
    .local v7, windowStyle:Ljava/lang/String;
    if-eqz v7, :cond_14
    ...
    .line 551
    .end local v7           #windowStyle:Ljava/lang/String;
    :cond_14
    :goto_b
    if-eqz v5, :cond_18

    .line 552
    iget v8, p0, Lcom/android/server/am/ActivityRecord;->currentWindowMode:I
    ...
    .restart local v6       #winOption:I
    .restart local v7       #windowStyle:Ljava/lang/String;
    :cond_16
