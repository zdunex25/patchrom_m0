...
.method public getDnsList()Ljava/util/List;
    ...
    const-string v7, "getCurLinkProperties:: LP for type"

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    iget v7, p0, Landroid/net/DnsPinger;->mConnectionType:I
    ...
    invoke-direct {p0, v6}, Landroid/net/DnsPinger;->loge(Ljava/lang/String;)V

    .line 279
    iget-object v5, p0, Landroid/net/DnsPinger;->mDefaultDns:Ljava/util/ArrayList;
    ...
    .line 284
    :cond_2
    const-string v6, "getDns::LinkProps has null dns - returning default"
    ...
    .line 289
    .local v5, tempDnses:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Ljava/net/InetAddress;>;"
    ...
    .line 291
    .local v4, invalidDns:Ljava/lang/String;
    ...
    .line 292
    sget-boolean v6, Landroid/net/DnsPinger;->DBG:Z
    ...
    const-string v7, "getDnsList:: add to Dns List "
    ...
    invoke-direct {p0, v6}, Landroid/net/DnsPinger;->log(Ljava/lang/String;)V
