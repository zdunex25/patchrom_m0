...
.method public enter()V
    ...
    invoke-static {v3}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$5304(Landroid/net/wifi/WifiWatchdogStateMachine;)I
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    invoke-static {v2}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$5400(Landroid/net/wifi/WifiWatchdogStateMachine;)Landroid/net/wifi/WifiWatchdogStateMachine$OnlineWatchState;

    move-result-object v2

    #calls: Landroid/net/wifi/WifiWatchdogStateMachine;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static {v1, v2}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$5500(Landroid/net/wifi/WifiWatchdogStateMachine;Lcom/android/internal/util/IState;)V
    ...
    invoke-static {v5}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$5304(Landroid/net/wifi/WifiWatchdogStateMachine;)I
    ...
    invoke-static {v3}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$5600(Landroid/net/wifi/WifiWatchdogStateMachine;)J
    ...
    invoke-static {v1}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$5708(Landroid/net/wifi/WifiWatchdogStateMachine;)I
    ...
    invoke-static {v1}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$5700(Landroid/net/wifi/WifiWatchdogStateMachine;)I
    ...
    invoke-static {v1}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$5800(Landroid/net/wifi/WifiWatchdogStateMachine;)V

    .line 1011
    iget-object v1, p0, Landroid/net/wifi/WifiWatchdogStateMachine$RssiMonitoringState;->this$0:Landroid/net/wifi/WifiWatchdogStateMachine;

    invoke-static {v1}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$5304(Landroid/net/wifi/WifiWatchdogStateMachine;)I
    ...
    invoke-static {v2, v1}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$5702(Landroid/net/wifi/WifiWatchdogStateMachine;I)I
